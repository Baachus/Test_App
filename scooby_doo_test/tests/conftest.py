'''This module contains the setup function for the family tree app tests.'''''
import pytest
...
def setup(page: Page):
    '''Setup function for the family tree app tests.'''
    ...
    return {
        "login": login_page,
        "header": header_page,
        "add_member": add_member_page,
        "remove_member": remove_member_page,
        "home": home_page}
