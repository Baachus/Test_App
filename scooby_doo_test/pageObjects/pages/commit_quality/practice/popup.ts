...
class PopupPage {
    ...
    // Random Popup Selectors
    popup_text = 'Random Popup'
    ...
    async getPopupText(): Promise<string> {
        return await this.page.getByText(this.popup_text).innerText();
    }

    async getPopup(): Promise<Locator> {
        return this.page.getByText(this.popup_text);
    }

    async clickPopupCloseButton() {
        await this.page.getByText(this.popup_close_button).click();
    }

    async getPopupCloseButton(): Promise<string> {
        return await this.page.getByText(this.popup_close_button).innerText();
    }

    async popupVisible(): Promise<boolean> {
        return await this.page.getByText(this.popup_text).isVisible();
    }
